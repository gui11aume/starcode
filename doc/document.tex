...
time of slidesort and starcode show a linear and sub-linear increase,
respectively. Seed and cd-hit run approximately in constant time
regardless of the cluster size. In spite of this trend, the
...
magnitude with respect to the other tools. Comparing with
...
Dataset 3 consists of paired-end reads.
...
\begin{tabular}{l|l c r}
    ...
    dataset 3 & 2,460,226    & 50+50  & paired-end \\
\end{tabular}
...
but it is the only other tool able to cluster paired-end reads. We did not
...
memory than seed and approximately as much as cd-hit.
