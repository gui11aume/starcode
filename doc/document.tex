...
3-matches in each dataset is not known (pairs of statellites
...
(more information is available on the starcode repository the, see
...
performing the Drosophila TRIP experiments used for benchmarking.
