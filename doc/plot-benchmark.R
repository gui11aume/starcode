...
starcode_pairs = c(NA, 277168690, 116797218, 96383875)
slidesort_pairs = c(NA, 263551040, 107392689, 87884477)
...
slidesort_time = c(3*60+38, 36*60+47, 384*60+38, 3840*60)
# Plot
pdf("benchmark.pdf")
par(mfrow=c(2,2))
...
plot(slidesort_pairs/1e6, starcode_pairs/1e6, type = "b",
     xlab = "Pairs in slidesort [millions]",
     ylab = "Pairs in starcode [millions]",
     cex.lab = 1.3)
abline(0,1, col=2)
