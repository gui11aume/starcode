...
slidesort and cd-hit. The memory usage of starcode is the highest
for clusters of size 1000, but it decreases and becomes lower than
the memory usage of seed as the size of the cluster increases.

In conclusion, starcode was the only tool to achieve perfect precision
on these datasets. It also maintains a competitive performance in
...
constant regions that may degrade the performance of the algorithm.
...
Dataset 3 consist of paired-end reads.
